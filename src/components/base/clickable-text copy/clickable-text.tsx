    ...
    <ClickableTextStyled.Container>
      {props.iconLeft && (
        <ClickableTextStyled.IconLeftContainer
          iconLeftMarginRight={props.iconLeftMarginRight}
        >
          ...
          props.styled
            ...
            : {
                ...
                color: props.colorText
                  ? props.colorText
                  : defaultStyleText["color"],
                fontFamily: props.fontFamily
                  ? props.fontFamily
                  : defaultStyleText["fontFamily"],
                fontSize: props.fontSize
                  ? props.fontSize
                  : defaultStyleText["fontSize"],
                textAlign: props.textAlign
                  ? props.textAlign
                  : defaultStyleText["textAlign"],
              }
        }
      >
        {props.text}
        <ClickableTextStyled.ClickableText
          ...
          styled={
            props.styled
              ...
              : {
                  ...defaultStyleText,
                  color: props.colorTextClickable
                    ? props.colorTextClickable
                    : Colors.Primary,
                  fontFamily: props.fontFamily
                    ? props.fontFamily
                    : defaultStyleText["fontFamily"],
